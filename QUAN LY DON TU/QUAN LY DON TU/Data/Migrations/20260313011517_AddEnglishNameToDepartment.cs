...
{
    /// <inheritdoc />
    public partial class AddEnglishNameToDepartment : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "BOD", new DateTime(2026, 3, 11, 22, 47, 32, 939, DateTimeKind.Local).AddTicks(9308), true, null, "Ban Giám đốc", null, 1 },
                    { 2, "IT", new DateTime(2026, 3, 11, 22, 47, 32, 939, DateTimeKind.Local).AddTicks(9310), true, null, "Phòng Công nghệ Thông tin", null, 1 },
                    { 3, "HR", new DateTime(2026, 3, 11, 22, 47, 32, 939, DateTimeKind.Local).AddTicks(9311), true, null, "Phòng Nhân sự", null, 1 },
                    { 4, "ACC", new DateTime(2026, 3, 11, 22, 47, 32, 939, DateTimeKind.Local).AddTicks(9312), true, null, "Phòng Kế toán", null, 1 },
                    { 5, "SALES", new DateTime(2026, 3, 11, 22, 47, 32, 939, DateTimeKind.Local).AddTicks(9322), true, null, "Phòng Kinh doanh", null, 1 },
                    { 6, "MKT", new DateTime(2026, 3, 11, 22, 47, 32, 939, DateTimeKind.Local).AddTicks(9323), true, null, "Phòng Marketing", null, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 3, 11, 22, 47, 32, 939, DateTimeKind.Local).AddTicks(9240), "Quản trị viên hệ thống", "Admin", 1 },
                    { 2, new DateTime(2026, 3, 11, 22, 47, 32, 939, DateTimeKind.Local).AddTicks(9244), "Hành chính Nhân sự", "HR", 1 },
                    { 3, new DateTime(2026, 3, 11, 22, 47, 32, 939, DateTimeKind.Local).AddTicks(9245), "Quản lý", "Manager", 1 },
                    { 4, new DateTime(2026, 3, 11, 22, 47, 32, 939, DateTimeKind.Local).AddTicks(9246), "Nhân viên", "Employee", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "DANGCAPNE Corporation", new DateTime(2026, 3, 11, 22, 47, 32, 939, DateTimeKind.Local).AddTicks(9045), null, true, "", 500, "Enterprise", "#6366f1", "#8b5cf6", "dangcapne" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(642), "Quản lý trực tiếp -> HR", true, "Luồng duyệt cơ bản", 1 },
                    { 2, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(645), "Quản lý -> Kế toán -> Giám đốc", true, "Luồng duyệt tài chính", 1 },
                    { 3, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(646), "Quản lý -> Trưởng phòng -> HR -> Giám đốc", true, "Luồng duyệt vượt cấp", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Leave", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(715), "", "bi-calendar-x", "#10b981", true, "Đơn xin nghỉ phép", false, 1, 1 },
                    { 2, "OT", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(723), "", "bi-clock-history", "#f59e0b", true, "Đơn làm thêm giờ (OT)", false, 1, 1 },
                    { 3, "Travel", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(724), "", "bi-airplane", "#3b82f6", true, "Đơn đi công tác", false, 1, 1 },
                    { 4, "Expense", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(726), "", "bi-cash-stack", "#ef4444", true, "Đơn tạm ứng chi phí", true, 1, 2 },
                    { 5, "Equipment", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(728), "", "bi-laptop", "#8b5cf6", true, "Đơn yêu cầu cấp phát thiết bị", false, 1, 1 },
                    { 6, "Leave", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(730), "", "bi-box-arrow-right", "#dc2626", true, "Đơn xin nghỉ việc", false, 1, 3 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, "", 1, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(221), 2, "employee@company.com", "NV004", "Phạm Thị Employee", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(221), 6, "vi-VN", "HSEqbOoWNtVcp7r8Ous+JPgWx7cfiZ9kKGR02yw1Vk8=", "0901234570", null, null, "Active", 1, null, "SE Asia Standard Time", false, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(222) },
                    { 5, "", 1, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(224), 2, "dev@company.com", "NV005", "Hoàng Văn Dev", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(224), 5, "vi-VN", "HSEqbOoWNtVcp7r8Ous+JPgWx7cfiZ9kKGR02yw1Vk8=", "0901234571", null, null, "Active", 1, null, "SE Asia Standard Time", false, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(224) },
                    { 7, "", 1, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(244), 5, "sales@company.com", "NV007", "Đỗ Văn Sales", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(237), 6, "vi-VN", "HSEqbOoWNtVcp7r8Ous+JPgWx7cfiZ9kKGR02yw1Vk8=", "0901234573", null, null, "Active", 1, null, "SE Asia Standard Time", false, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(244) },
                    { 8, "", 1, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(247), 6, "marketing@company.com", "NV008", "Ngô Thị Marketing", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(247), 6, "vi-VN", "HSEqbOoWNtVcp7r8Ous+JPgWx7cfiZ9kKGR02yw1Vk8=", "0901234574", null, null, "Active", 1, null, "SE Asia Standard Time", false, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(247) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0.0, 0.0, 1, 0.0, 1, 12.0, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(903), 3.0, 4, 2026 },
                    { 2, 0.0, 0.0, 2, 0.0, 1, 30.0, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(907), 1.0, 4, 2026 },
                    { 3, 0.0, 0.0, 1, 0.0, 1, 12.0, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(909), 2.0, 5, 2026 },
                    { 4, 0.0, 0.0, 2, 0.0, 1, 30.0, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(910), 0.0, 5, 2026 },
                    { 5, 0.0, 0.0, 1, 0.0, 1, 12.0, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(911), 5.0, 7, 2026 },
                    { 6, 0.0, 0.0, 1, 0.0, 1, 12.0, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(912), 1.0, 8, 2026 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 2, null, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(973), false, "Chào mừng bạn đến với hệ thống quản lý đơn từ DANGCAPNE", null, null, 1, "Chào mừng!", "Info", 4 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2026, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, "Normal", "REQ-20260305-001", 4, "Pending", 1, "Xin nghỉ phép năm 3 ngày", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(1009) },
                    { 2, new DateTime(2026, 3, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2026, 3, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 2, "Normal", "REQ-20260307-001", 5, "Approved", 1, "Làm thêm giờ dự án ERP", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(1021) },
                    { 3, null, new DateTime(2026, 3, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 4, "High", "REQ-20260310-001", 7, "InProgress", 1, "Tạm ứng đi công tác Đà Nẵng", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(1026) },
                    { 4, new DateTime(2026, 3, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2026, 3, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, "Normal", "REQ-20260311-001", 8, "Rejected", 1, "Xin nghỉ phép 1 ngày", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(1029) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(297), 4, 4 },
                    { 5, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(298), 4, 5 },
                    { 7, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(300), 4, 7 },
                    { 8, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(300), 4, 8 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "", 1, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(207), 1, "admin@company.com", "NV001", "Nguyễn Văn Admin", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(205), 1, "vi-VN", "HSEqbOoWNtVcp7r8Ous+JPgWx7cfiZ9kKGR02yw1Vk8=", "0901234567", null, 1, "Active", 1, null, "SE Asia Standard Time", false, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(208) },
                    { 2, "", 1, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(215), 3, "hr@company.com", "NV002", "Trần Thị HR", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(214), 3, "vi-VN", "HSEqbOoWNtVcp7r8Ous+JPgWx7cfiZ9kKGR02yw1Vk8=", "0901234568", null, 3, "Active", 1, null, "SE Asia Standard Time", false, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(215) },
                    { 3, "", 1, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(218), 2, "manager@company.com", "NV003", "Lê Văn Manager", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(218), 3, "vi-VN", "HSEqbOoWNtVcp7r8Ous+JPgWx7cfiZ9kKGR02yw1Vk8=", "0901234569", null, 2, "Active", 1, null, "SE Asia Standard Time", false, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(218) },
                    { 6, "", 1, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(227), 4, "accountant@company.com", "NV006", "Vũ Thị Kế Toán", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(226), 3, "vi-VN", "HSEqbOoWNtVcp7r8Ous+JPgWx7cfiZ9kKGR02yw1Vk8=", "0901234572", null, 4, "Active", 1, null, "SE Asia Standard Time", false, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(227) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "/Approvals", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(968), false, "Phạm Thị Employee đã tạo đơn xin nghỉ phép", null, null, 1, "Đơn mới cần duyệt", "Approval", 3 },
                    { 3, "/HR", new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(974), false, "Có 5 đơn mới cần HR xử lý trong tuần này", null, null, 1, "Báo cáo tuần", "Info", 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, true, 3, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(335), 4 },
                    { 2, null, true, 3, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(337), 5 },
                    { 3, null, true, 1, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(338), 3 },
                    { 4, null, true, 1, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(338), 2 },
                    { 5, null, true, 1, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(339), 7 },
                    { 6, null, true, 1, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(340), 8 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(293), 1, 1 },
                    { 2, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(295), 2, 2 },
                    { 3, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(296), 3, 3 },
                    { 6, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(299), 4, 6 },
                    { 9, new DateTime(2026, 3, 11, 22, 47, 32, 940, DateTimeKind.Local).AddTicks(301), 3, 1 }
                });
